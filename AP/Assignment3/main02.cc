...
int main(int argc, char** argv) {
	...
	SDL_Window* window = SDL_CreateWindow(argv[0], SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 800, 800, 0);
	if (!window) {
	...
	horizontal root(new text(sdl_renderer, "hello!", 30, 0, 0, 0, 1, 1, 1), new checkered());
